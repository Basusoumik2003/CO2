    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-top">
          <h3>🌱 CarbonCredit</h3>
          <p>
            Empowering individuals and organizations to track, reduce, and earn rewards 
            for their environmental impact through sustainable practices.
          </p>
        ...
        <div className="footer-links-section">
          ...
          <div>
            <h4>Services</h4>
            <ul>
              <li><a href="#ev-tracking">EV Tracking</a></li>
              <li><a href="#solar-energy">Solar Energy</a></li>
              <li><a href="#tree-planting">Tree Planting</a></li>
              <li><a href="#carbon-credits">Carbon Credits</a></li>
          ...
          <div>
            <h4>Contact</h4>
            <ul>
              <li><i className="fas fa-envelope"></i> support@carboncredit.com</li>
